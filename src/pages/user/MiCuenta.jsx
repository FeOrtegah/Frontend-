...
import ventaService from "../../services/VentaService"; // CORREGIDO: Importación por defecto
...
  // 1. Lógica de Redirección y Carga de Ventas
  useEffect(() => {
...
    }
    ...
    // Si hay usuario, cargar las ventas.
    cargarVentas();
  }, [user, navigate]); // Dependencias: user, navigate (para evitar bucles en la redirección)

  // Funciones de utilidad para cálculo y formato
...
  // Manejo de estados de carga y no autenticado (Optimizado)
  if (!user) {
    // Si user es null, el useEffect ya disparó la navegación.
    // Solo mostramos un spinner rápido mientras se resuelve la redirección.
    return (
