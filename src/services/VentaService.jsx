...
class VentaService {
    ...
    calcularTotalVenta(venta) {
        if (!venta) return 0;
        if (venta.total !== undefined && venta.total !== null) return Number(venta.total);
...
const MiCuentaComponent = ({ user, setUser, navigate }) => {
    ...
    if (!user) return <Container className="text-center"><Spinner /></Container>;
    ...
    return (
        <Container className="max-w-6xl my-5 font-sans">
            <h2 className="text-center text-3xl mb-4">Mi Cuenta</h2>
                ...
                <Col md={10}>
                    <Card className="mb-4">
                        ...
                        <Card.Body>
                            ...
                            <p><strong>Rol:</strong> <Badge bg={esAdmin ? 'danger' : 'success'}>{rolName}</Badge></p>
                    ...
                    <Card className="mb-4">
                        ...
                        <Card.Body>
                            {loadingVentas ? (
                                <div className="text-center"><Spinner /><p>Cargando ventas...</p></div>
                            ) : ventas.length === 0 ? (
...
export { ventaService, MiCuentaComponent };
